	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			if (this.options.mode === 'public') {
				listItem += "<div class='jukebox-action'>";
				listItem += "<div class='jukebox-price-value'>" + media.price_tinidiem + "</div>";
				listItem += "<div class='jukebox-price-icon'></div>";
				listItem += "<div class='jukebox-btn-buy' data-id='" + media._id + "'></div>";
				listItem += "</div>";
			}
			listItem += "<div>";
			...
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.name + (media.singer ? "<br/><div class='jp-artist jukebox'>" + media.singer + "</div>" : "") + "</a>";
			listItem += "</div></li>";
		...
		select: function(index) {
			...
			if(0 <= index && index < this.playlist.length) {
				...
				//L.Le
				$(this.cssSelector.jPlayer).jPlayer("setMedia", this.playlist[this.current].url);
			} else {
				this.current = 0;
			}
		},
